...
class BulkPasswordViewPostTests(TransactionTestCase):
    c = Client()
    path = '/bulk_password/'
    ...
    def test_bulk_password_form_invalid_change_list_post(self):
    ...
    def test_bulk_password_form_post_correct(self):
    ...
    def test_bulk_password_form_post_nonexistent_credential(self):
    ...
    def test_bulk_password_form_post_existent_credential_single_service(self):
